...
const API_RE = /^\/(auth|students|leaders|prayers|connections|overview|trends|lifegroups|at-risk|import|settings|admin|accounts|audits|health|batch|manifest\.json)(\/|$|\?)/;
